...
<div class="main-content fade-in">
    ...
    <button class="btn btn-primary mb-20" onclick="document.getElementById('notifyModal').classList.add('active')">+
            ...
            <tbody>
                ...
                <?php else:
                    foreach ($notifications as $notify): ?>
                        <tr data-id="<?php echo $notify['id']; ?>"
                            data-message="<?php echo htmlspecialchars($notify['message'], ENT_QUOTES); ?>">
                            <td><?php echo htmlspecialchars(substr($notify['message'], 0, 80)); ?><?php echo strlen($notify['message']) > 80 ? '...' : ''; ?>
                            </td>
                            <td>
                                <button class="btn btn-secondary btn-sm"
                                    onclick="editNotify(<?php echo $notify['id']; ?>)">Sửa</button>
                                <button class="btn btn-danger btn-sm"
                                    onclick="deleteNotify(<?php echo $notify['id']; ?>)">Xóa</button>
                            </td>
                        </tr>
