                        ...
                        <tr>
                            ...
                            <td>
                                <button class="btn btn-secondary btn-sm"
                                    onclick="editProduct(<?php echo $product['id']; ?>)">Sửa</button>
                                <button class="btn btn-danger btn-sm"
                                    onclick="deleteProduct(<?php echo $product['id']; ?>)">Xóa</button>
                            </td>
                        </tr>
    ...
    <div class="modal-content" style="max-width: 700px; max-height: 90vh; overflow-y: auto;">
        ...
        <form id="productForm" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <div id="demoPreview" class="demo-preview"
                    style="display:flex; gap:8px; flex-wrap:wrap; margin-top:6px;"></div>
            </div>

            <div class="form-group">
                <label>Link video YouTube</label>
                <input type="text" name="tutorial_video_url"
                    placeholder="https://www.youtube.com/watch?v=VIDEO_ID hoặc https://www.youtube.com/embed/VIDEO_ID">
            </div>
            ...
            <div class="form-group">
                ...
                <div id="durationsEditor" style="border:1px dashed #ddd; padding:10px; border-radius:6px;">
                    <div id="durationsList" style="display:flex; flex-direction:column; gap:8px; margin-bottom:8px;">
                    </div>
                    <div style="display:flex; gap:8px; align-items:center; flex-wrap:wrap;">
                        ...
                        <small class="text-muted">Để "Vĩnh viễn" để trống ô "Số ngày". Label sẽ tự tạo khi để
                            trống.</small>
                    </div>
                </div>
            </div>
