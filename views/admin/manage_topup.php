                ...
                <?php if (!empty($requests)): ?>
                    <?php foreach ($requests as $r): ?>
                        ...
                        <tr>
                            ...
                            <td><?php echo convertToVNTime($r['created_at']); ?></td>
                            <td>
                                <button class="btn btn-success btn-sm"
                                    onclick="openApproveModal(<?php echo $r['id']; ?>)">Duyệt</button>
                                <button class="btn btn-danger btn-sm" onclick="openRejectModal(<?php echo $r['id']; ?>)">Từ
                                    chối</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
...
<div id="approveModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3>Duyệt yêu cầu</h3><span class="modal-close" onclick="closeModal('approveModal')">&times;</span>
        </div>
...
<div id="rejectModal" class="modal">
    <div class="modal-content">
        <div class="modal-header">
            <h3>Từ chối yêu cầu</h3><span class="modal-close" onclick="closeModal('rejectModal')">&times;</span>
        </div>
        <div class="modal-body">
